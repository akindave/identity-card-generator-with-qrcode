...
session_start();
if(isset($_SESSION['library_staff'])){
            ...
            <form action="" method="POST">
                            <div class="text-box-cont" id="data-matric">
                                ...
                                <div class="input-group mb-3" id="fullname-container">
                                    ...
                                    <input type="text" class="form-control" name="id" id="id" placeholder="Library User" aria-label="Faculty" aria-describedby="basic-addon1" required>
                                </div>
                           ...
                           <div class="inn-cover">
                               <div class="ditk-inf">
                                ...
                                <!-- <i aria-hidden="true" class="fab fa-asymmetrik"></i> Style Login -->
                                    ...
                                    <a href="../index.html#">
                                    <button type="button" class="btn btn-outline-light"><strong></strong> <i aria-hidden="true" class="fa fa-envelope-o"></i>AkindaveTechnology</button>
                                    </a>
                                </div>

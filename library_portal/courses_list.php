            ...
            <form action="#" method="POST">
                            <div class="text-box-cont" id="data-matric">
                                ...
                                <div class="input-group center">
                                    <a href="student_detail.php?coursecode=csc301" class=" btn-block "><button type="button" class="btn btn-danger btn-md btn-round" style="font-size:20px; background: rgba(230, 230, 230, 0.075); color: #e91e63; border:2px solid #e91e63"><i aria-hidden="true" class="fa fa-book"></i>CSC 301</button></a>
                                </div>

                           ...
                           <div class="inn-cover">
                               <div class="ditk-inf">
                                ...
                                <!-- <i aria-hidden="true" class="fab fa-asymmetrik"></i> Style Login -->
                                    ...
                                    <h2 id="oya" class="w-100">Library Page</h2>
                                    <p>Features:
                                   <br>
                                        1.View List
                                        2.Scan
                                    ...
                                    <a href="#">
                                    <button type="button" class="btn btn-outline-light"><strong></strong> <i aria-hidden="true" class="fa fa-envelope-o"></i>MULTIPURPOSE STUDENTS IDENTITY CARD </button>
                                    </a>
                                </div>
                                 <div class="foter-credit">
                                 Developed by : <a href="https://osustech.edu.ng/" style="font-weight:bold">EYIARO AYOBAMI</a>  
                               </div>
                           </div>
                        </div>
                    </div>

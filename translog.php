...
$db = DB::getInstance()->query_two("select * from transaction_log where payee = '{$id}'");
			...
			<div class="row">
				<div class="col s12">
					<div class="entry">
						...
						$a=1;
						while($r = $db->fetch()){
							$db2 = DB::getInstance()->query_two("select * from seller_table where id = '{$r['receiver']}'");
							$r2 = $db2->fetch();
							?>
						<tr>
						
							<td><?php echo $a; ?></td>
							<td><?php echo $r2['business_name']; ?></td>

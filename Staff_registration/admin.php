...
$sqluser ="SELECT * FROM admin WHERE password='$userid' && email='$useremail'";
...
$(document).ready(function(){  
      ...
      <?php   $sqlid ="SELECT * FROM admin Order BY id DESC";
...
$sqluse ="SELECT * FROM student_information ORDER BY id DESC ";
$retrieve = mysqli_query($db,$sqluse);
    while($foundk = mysqli_fetch_array($retrieve))
	     {
              $name = $foundk['fullname'];
		      $website= $foundk['matric_no'];
              $phone= $foundk['department'];
              $year= $foundk['programme'];
			  $mail= $foundk['email'];
			  $idz= $foundk['id'];
		 }	 
      ...
      <div class="modal-body" >
        <center>
        	...
        	<form method="post" action="upload.php" enctype='multipart/form-data'>        		
        	      ...
        	      <p style="margin-bottom:10px;"><span style="font-size: 18px; font-weight: bold;">&nbsp; &nbsp;Fullname:<label style="color: red;font-size:20px;">*</label><input style="width:270px;" type="text" name="mfname" id='oldname'></span></p>
        	    <p style="margin-bottom:10px;"><span style="font-size: 18px; font-weight: bold;">&nbsp; &nbsp;&nbsp; &nbsp;Matric No:<label style="color: red;font-size:20px;">*</label><input style="width:270px;" type="text" name="mat" id='ss'></span></p>
        		<p style="margin-bottom:10px;"><span style="font-size: 18px; font-weight: bold;">Programme:<label style="color: red;font-size:20px;">*</label><input style="width:270px;" type="text" name="dept"  id='cc'></span></p>
        	     <p style="margin-bottom:10px;"><span style="font-size: 18px; font-weight: bold;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Email:<label style="color: red;font-size:20px;">*</label><input style="width:270px;" type="text" name="email" id='dd'></span></p>
        	     <p style="margin-bottom:10px;"><span style="font-size: 18px; font-weight: bold;">&nbsp;Contact:<label style="color: red;font-size:20px;">*</label><input style="width:270px;" type="text" name="phone" id='bb'></span></p>
...
<div id="addlecturer" class="modal fade" role="dialog">
    <div class="modal-dialog">
        <!-- Modal content-->
        <div class="modal-content" style="font-size: 14px; font-family: Times New Roman;color:black;">
            <div class="modal-header" style="background:#222d32">
            ...
            <div class="modal-body" >
                <center>
                    <form method="post" action="upload.php" enctype='multipart/form-data' style="width: 98%;">
                        ...
                        <p style="margin-bottom:10px;"><span style="font-size: 18px; font-weight: bold;">&nbsp; &nbsp;Full Name<label style="color: red;font-size:20px;">*</label><input style="width:270px;" type="text" name="fname"></span></p>
                        <p style="margin-bottom:10px;"><span style="font-size: 18px; font-weight: bold;">&nbsp; &nbsp;Staff Id<label style="color: red;font-size:20px;">*</label><input style="width:270px;" type="text" name="stfid"></span></p>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   <p style="margin-bottom:10px;"><span style="font-size: 18px; font-weight: bold;">&nbsp;Password:<label style="color: red;font-size:20px;">*</label><input style="width:270px;" type="text" name="pass"></span></p>
   ...
   <div id="addseller" class="modal fade" role="dialog">
  <div class="modal-dialog">
    <!-- Modal content-->
    <div class="modal-content" style="font-size: 14px; font-family: Times New Roman;color:black;">
      <div class="modal-header" style="background:#222d32">
      ...
      <div class="modal-body" >       	
      	<center> 
        		<form method="post" action="upload.php" enctype='multipart/form-data' style="width: 98%;">        		
                 ...
                 <p style="margin-bottom:10px;"><span style="font-size: 18px; font-weight: bold;">&nbsp; &nbsp;Full Name:<label style="color: red;font-size:20px;">*</label><input style="width:270px;" type="text" name="fname"></span></p>
                 <p style="margin-bottom:10px;"><span style="font-size: 18px; font-weight: bold;">&nbsp; &nbsp;Registration Id:<label style="color: red;font-size:20px;">*</label><input style="width:270px;" type="text" name="regid"></span></p>
                 <p style="margin-bottom:10px;"><span style="font-size: 18px; font-weight: bold;">&nbsp; &nbsp;Business Name:<label style="color: red;font-size:20px;">*</label><input style="width:270px;" type="text" name="bname"></span></p>
					</p>
        	     <p style="margin-bottom:10px;"><span style="font-size: 18px; font-weight: bold;">&nbsp;Password:<label style="color: red;font-size:20px;">*</label><input style="width:270px;" type="text" name="pass"></span></p>
      ...
      <div class="modal-footer">
       <input type="submit" class="btn btn-success" value="Submit" id="addseller" name="addseller"> &nbsp;
        <button type="button" class="btn btn-success" data-dismiss="modal">Close</button>
      </div>
      </div>
       </form>
   ...
   <div id="Userstu" class="modal fade" role="dialog">
  <div class="modal-dialog">
    <!-- Modal content-->
    <div class="modal-content" style="font-size: 14px; font-family: Times New Roman;color:black;">
      <div class="modal-header" style="background:#222d32">
      ...
      <div class="modal-body" >       	
      	<center> 
        		<form method="post" action="upload.php" enctype='multipart/form-data' style="width: 98%;">        		
                 ...
                 <p style="margin-bottom:10px;"><span style="font-size: 18px; font-weight: bold;">&nbsp; &nbsp;Fullname:<label style="color: red;font-size:20px;">*</label><input style="width:270px;" type="text" name="fname"></span></p>
        			<style="margin-bottom:10px;"><span style="font-size: 18px; font-weight: bold;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Department:<label style="color: red;font-size:20px;">*</label><select style="width:270px;" type="text" name="mat">
					
					<?php 
					$sqluse ="SELECT * FROM departments";
$retrieve = mysqli_query($db,$sqluse);
    while($foundk = mysqli_fetch_array($retrieve))
	     {
			 ?>
					<option value="<?php echo $foundk['department']; ?>"><?php echo $foundk['department']; ?></option>
		 ...
		 <?php }?>
				 ...
				 <p style="margin-bottom:10px;"><span style="font-size: 18px; font-weight: bold;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Matric No:<label style="color: red;font-size:20px;">*</label><input style="width:270px;" type="text" name="mat"></span></p>
                    <p style="margin-bottom:10px;"><span style="font-size: 18px; font-weight: bold;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Programme:<label style="color: red;font-size:20px;">*</label><select style="width:270px;" type="text" name="prog">
					<?php 
					$sqluse ="SELECT * FROM programmes";
$retrieve = mysqli_query($db,$sqluse);
    while($foundk = mysqli_fetch_array($retrieve))
	     {
			 ?>
					<option value="<?php echo $foundk['programme']; ?>"><?php echo $foundk['programme']; ?></option>
      ...
      <div class="modal-footer">
       <input type="submit" class="btn btn-success" value="Submit" id="addmember" name="addstudent"> &nbsp;
        <button type="button" class="btn btn-success" data-dismiss="modal">Close</button>
      </div>
      </div>
       </form>
     ...
     <div id="Usercourse" class="modal fade" role="dialog">
  <div class="modal-dialog">
    <!-- Modal content-->
    <div class="modal-content" style="font-size: 14px; font-family: Times New Roman;color:black;">
      <div class="modal-header" style="background:#222d32">
      ...
      <div class="modal-body" >       	
      	<center> 
        		<form method="post" action="upload.php" style="width: 98%;">        		

        		                                                           	      		
                 <p style="margin-bottom:10px;"><span style="font-size: 18px; font-weight: bold;">&nbsp; &nbsp;Course Name<label style="color: red;font-size:20px;">*</label><input style="width:270px;" type="text" name="coursename"></span></p>
        		<p style="margin-bottom:10px;"><span style="font-size: 18px; font-weight: bold;">Course Code:<label style="color: red;font-size:20px;">*</label><input style="width:270px;" type="text" name="coursecode"></span></p>
        	     <p style="margin-bottom:10px;"><span style="font-size: 18px; font-weight: bold;">&nbsp;lecturer:<label style="color: red;font-size:20px;">*</label>
                     <select style="width:270px;" name="lecturer">
                    <?php 
                     $sqluse ="SELECT * FROM lecturer_details ";
$retrieve = mysqli_query($db,$sqluse);
    while($foundk = mysqli_fetch_array($retrieve))
	     {
             ?>
                        
                     <option value="<?php echo $foundk['id']; ?>"><?php echo $foundk['name']; ?></option>
      ...
      <div class="modal-footer">
       <input type="submit" class="btn btn-success" value="Submit" id="addmember" name="addcourse"> &nbsp;
        <button type="button" class="btn btn-success" data-dismiss="modal">Close</button>
      </div>
      </div>
       </form>
     ...
     <div id="Loadmoney" class="modal fade" role="dialog">
  <div class="modal-dialog">
    <!-- Modal content-->
    <div class="modal-content" style="font-size: 14px; font-family: Times New Roman;color:black;">
      <div class="modal-header" style="background:#222d32">
      ...
      <div class="modal-body" >       	
      	<center> 
        		<form method="post" style="width: 98%;">        		
        		    ...
        		    <p id="load_error"></p>                                                       	      		
                 <p id="mat" style="margin-bottom:10px;"><span style="font-size: 18px; font-weight: bold;">&nbsp; &nbsp;Matric No<label style="color: red;font-size:20px;">*</label><input style="width:270px;" type="text" id="matricload"></span></p>
                    <p id="amt" style="margin-bottom:10px;display:none;"><span style="font-size: 18px;  font-weight: bold;">&nbsp; &nbsp;Enter Amount<label style="color: red;font-size:20px;">*</label><input style="width:270px;" type="text" id="amount" value="#"></span></p>
                    <button class="btn btn-success" id="con" type="button">Continue</button>
                    <button class="btn btn-success" id="load" style="display:none;" type="button">Load</button>
        		   <input type="hidden" name="page" value="admin.php"/>                                                        	      		
         </center>
      </div>
      <div class="modal-footer">
				...
				$sqln ="SELECT * FROM admin ";
                   ...
                   if($numb!=0){
                            while($foundl = mysqli_fetch_array($rgetb))
										...
										echo"<center><img src='images/$profile'  width='40%' height='40%' style='border-radius:30px;' alt=''></center>";	   
                               }
							else{
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="sidebar-menu">
              ...
              <li class="treeview">
                  ...
                  <a data-toggle='modal' data-id='' href='#Userstu' class='open-adduser'><i class="fa fa-plus"></i>Add Student</a>
                  <a data-toggle='modal' data-id='' href='#addlecturer' class='open-adduser'><i class="fa fa-plus"></i>Add Lecturer</a>
                  <a data-toggle='modal' data-id='' href='#addseller' class='open-adduser'><i class="fa fa-plus"></i>Add Seller</a>
                  <a data-toggle='modal' data-id='' href='#Usercourse' class='open-adduser'><i class="fa fa-book"></i>Add Course</a>
                  <a data-toggle='modal' data-id='' href='#Loadmoney' class='open-adduser'><i class="fa fa-money"></i>Load Money</a>
<!--
                  <a data-toggle='modal' data-id='' href='#Useradd' class='open-adduser'><i class="fa fa-user"></i>Add </a>
...
-->
        ...
        <tbody>
        	 <?php   $sqlmember ="SELECT * FROM student_information ";
			      ...
			      echo"<tr>    <td>$id</td>                                       
			                 ...
			                 <td>
			                   <a data-toggle='modal' data-id='$id' data-ie='$name'   data-if='$mat_no' data-ig='$dept' data-ih='$programme' data-ij='$email' class='open-Passwords btn  btn-info' title='edit user details' href='#Passwords'><span class='glyphicon glyphicon-edit' style='color:white;'></span></a>
	...
	<!--footer-->
	<div class="footer">
	  <p>©2019 Designed by Eyiaro Ayobami
               ...
               var matric = $('#matricload').val(); 
                ...
                $.ajax({
                    ...
                    success:function(data){
                        if(data != "f"){
                              $('#load_error').html("You want to load for "+data+"?");
                            $('#mat').hide();
                            $('#con').hide();
                            $('#amt').show();
                            $('#load').show();
                        }else{
                             $('#load_error').text("Invalid User");
                        }
                    }
                });
            });

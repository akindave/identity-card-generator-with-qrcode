            ...
            <form action="#" method="POST">
                            <div class="text-box-cont" id="data-matric">
                                ...
                                <div class="input-group center">
                                    <a href="course_list_two.php" class=" btn-block "><button type="button" class="btn btn-danger btn-md btn-round" style="font-size:20px; background: rgba(230, 230, 230, 0.075); color: #e91e63; border:2px solid #e91e63"><i aria-hidden="true" class="fa fa-pencil"></i>Attendance Lists</button></a>
                                </div>
                                
                                <div class="input-group center">
                                    <a href="courses_list.php" class=" btn-block"><button type="button" class="btn btn-default btn-md btn-round" style=" font-size:20px; background: rgba(230, 230, 230, 0.075) !important; color:#000000f2; border:2px solid #000000f2;" ><i aria-hidden="true" class="glyphicon glyphicon-book"></i>Courses</button></a>
                                </div> 
                                
                                <div class="input-group center">
                                    <a href="courses_list.php" class=" btn-block "><button type="button" class="btn btn-primary btn-md btn-round" style="font-size:20px; background: rgba(230, 230, 230, 0.075) !important; color:#3f51b5; border:2px solid #3f51b5"><i aria-hidden="true" class="glyphicon glyphicon-qrcode"></i>Scan For Attendance</button></a>
                                </div>
								
								  <div class="input-group center">
                                    <a href="#" class=" btn-block "><button type="button" class="btn btn-danger btn-md btn-round" style="font-size:20px; background: rgba(230, 230, 230, 0.075); color: #e91e63; border:2px solid #e91e63"><i aria-hidden="true" class="fa fa-pencil"></i>Students</button></a>
                                </div>
								<div class="input-group center">
                                    <button type="button" class="btn btn-primary btn-md btn-round logout" style="font-size:20px; background: rgba(230, 230, 230, 0.075) !important; color:#000000f2; border:2px solid #000000f2"><i aria-hidden="true" class="glyphicon glyphicon-qrcode"></i>Log Out</button>
                                </div> 

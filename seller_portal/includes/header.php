...
$db = DB::getInstance()->fetch_all("seller_table","registration_id",$id);



$result = DB::getInstance()->query_two("select * from products where seller_id = '{$db['id']}'");
...
<body>
	...
	<div class="navbar">
		<div class="container">
			...
			<div class="site-title">
                <?php
                if(!isset($_SESSION['login_seller_name'] )){
                $user = "Guest";
              
                }else{
                    $user =$_SESSION['login_seller_name'] ;  
                    //$price =20000;
                }
                ?>
				<a href="index.php" class="logo"><span class="fa fa-user"> Welcome <?php echo $user; ?></span></a><?php if(isset($_SESSION['login_seller_picture'])){?><img src="../student_image/<?php echo $_SESSION['login_seller_picture'];?>" width="35px" height="35px" style="border-radius:40px"/><?php }?>
			</div>
             <?php
                if(isset($_SESSION['login_seller_name'] )){?>
	...
	<div class="panel-control-left">
		<ul id="slide-out-left" class="side-nav collapsible"  data-collapsible="accordion">
			<li>
				<div class="photos">
					<img src="../student_image/<?php echo $_SESSION['login_seller_picture']; ?>" alt="">
					<?php 
					if(isset($_SESSION['login_student_name'])){
						?>
					<h3><?php echo $_SESSION['login_seller_name']; ?> </h3>
					<?php }else{
						echo "<h3>GUEST</h3>";
					}?>
				</div>
			...
			<li>
				<a href="#" class=""><i class="fa fa-plus "></i>Add Product</a>
			</li>
			<li>
				<a href="#" class=""><i class="fa fa-pencil "></i>Edit details</a>
			</li>
